...
<div class="modal fade" id="modalTambah" role="dialog">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form role="form" action="home/tambahAcara" method="post" class="form-group">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Tutup"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">Masukkan Data</h4>
         </div>
         <div class="modal-body">
            <label>Nama acara :</label><input type="text" name="nama_acara" class="form-control" placeholder="Nama acara"><br>
            <label>Guest Star :</label><input type="text" name="gs" class="form-control" placeholder="Guest Star"><br>
             <label>Genre :</label>
            ...
            <label>Harga :</label><input type="text" name="harga" class="form-control" placeholder="Harga tiket"><br>
            <label>Tanggal :</label><input type="date" name="tanggal" class="form-control" placeholder="Tanggal"><br>
            <label>Deskripsi :</label><input type="text" name="deskripsi" class="form-control" placeholder="Deskripsi acara"><br>
            <label>Rating</label><input type="text" name="rating" class="form-control" placeholder="Rating acara"><br>
            <label>Gambar</label><input type="file" name="gambar" class="form-control" placeholder="Browse"><br>
